...
#PBS -q cheminf
#PBS -l select=1:ncpus=4:mem=14gb
...
MODEL=$MODEL
JOBS_INFO="jobs_info_burg_$MODEL.txt"

DATADIR=/home/$USER/benchmarking
SCRATCHDIR=/scratch/$USER/$PBS_JOBID
SCRATCH_OUT="output"
OUT_DIR="jobs_output"
OUT_JOB="bench_batch_BURG_${MODEL}_${PREFIX}_$PBS_JOBID"
...
python python_scripts/burger_first/one_for_all_$SCRIPT.py $PREFIX $MODEL $STEP $NUM
